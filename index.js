const fetch = require('node-fetch'),
    ...
    admins = ["468890664885682187", "839218813664493609", "yourid"],
    config = {
        "834436496550789150": 1500,
        "834436468209745920": 75,
        "834436448466894908": 50,
        "834436427634311208": 20,
        "834436427634311208": 10,
        "825481455932932096": 5
    }
...
client.on('message', async (message) => {
    ...
    if (command === "tfollow") {
        ...
        //if (admins.includes(message.author.id)) {
            ...
            message.channel.send(new Discord.MessageEmbed().setColor('GREEN').setDescription(`Adding **25** followers to \`${args[0]}\` !`))
...
client.login("ODM0NDMyNzE3NTI0Njk3MTMw.YIA0Bg.ZjUlSiPhXBVxZa2KzQvpGnIx4Ks")
